...
public class FunctionsOverview {
    public static void main(String[] args) {
        ...
        System.out.println("....");
        variableKwargsFunction(Map.of());
        variableKwargsFunction(Map.of("a", b, "z", "z-argument"));
    ...
    static void variableKwargsFunction(Map<String, Object> kwargs) {
        System.out.printf("Variable kw args function: %s\n", kwargs);
    }
}
